...
<div id="MainArea">
        ...
        <tbody id="TableData" class="dataContainer" datakey="documentTemplateList">
        	<s:iterator value="list">
				<tr class="TableDetail1 template">
						...
						<td>${pdKey}&nbsp;</td>
						<td><a onClick="return delConfirm()" href="${pageContext.request.contextPath }/templateAction_delete.action?id=${id}">删除</a>
							<a href="${pageContext.request.contextPath }/templateAction_editUI.action?id=${id}">修改</a>
							<a href="${pageContext.request.contextPath }/templateAction_downloadFile.action?id=${id}">下载</a>
						</td>
				</tr>
			</s:iterator>
        </tbody>
    ...
    <div id="TableTail">
        <div id="TableTail_inside">
			<a href="${pageContext.request.contextPath}/templateAction_saveUI.action"><img src="${pageContext.request.contextPath}/style/blue/images/button/addNew.PNG" /></a>
        </div>
    </div>
