...
<!--显示表单内容-->
<div id=MainArea>
	<form action="${pageContext.request.contextPath}/templateAction_updateTemplate.action" method="post"
            ...
            <div class="ItemBlock">
                <table cellpadding="0" cellspacing="0" class="mainForm">
                    ...
                    <tr>
                        <td>所用流程</td>
                        <td>
                        	<s:select cssClass="SelectStyle" name="pdKey" list="list" listKey="key" listValue="name" ></s:select> *
						</td>
                    </tr>
                </table>
            </div>
