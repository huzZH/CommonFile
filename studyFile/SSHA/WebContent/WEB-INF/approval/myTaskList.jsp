        ...
        <tbody id="TableData" class="dataContainer" datakey="formList">
        	<s:iterator value="list">
				<tr class="TableDetail1 template">
					<td><a href="${pageContext.request.contextPath}/applicationAction_showForm.action?applicationId=${application.id}">${application.title}</a></td>
					<td>${application.applicant.name}&nbsp;</td>
					<td>
						<s:date name="application.applyDate" format="yyyy-MM-dd HH:mm:ss"/>
					&nbsp;</td>
					<td><a href="${pageContext.request.contextPath }/applicationAction_approveUI.action?applicationId=${application.id}&taskId=${task.id}">审批处理</a>
						<!-- <a href="showForm.html">查看申请信息</a> -->
						<a href="${pageContext.request.contextPath}/applicationAction_approveFlow.action?applicationId=${application.id}">查看流转记录</a>
					</td>
				</tr>
			</s:iterator>
        </tbody>
